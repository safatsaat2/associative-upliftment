        ...
        <div className="bg-black w-full rounded-3xl mt-8">
            <div className="lg:flex lg:justify-between items-center w-full p-6">
                <div className="text-white ">
                    <h1 className="lg:text-[100px] leading-[115px] pb-4 w-full lg:w-[710px]">Grow Your <span className="text-[#1A9755]">Business</span> By Joining us</h1>
                    ...
                    <button className='bg-white text-black rounded-lg w-[217px] h-[48px] font-semibold'>Get Started</button>
                </div>
                <div>
