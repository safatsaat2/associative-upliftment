  ...
  return (
    <div className="">
      ...
      <div className="grid grid-cols-3 gap-6">
        ...
        <div className="bg-white dashShadow rounded-[10px]"></div>
        <div className="bg-white dashShadow rounded-[10px] flex flex-col justify-center items-center">
          <p className="text-center mb-4 font-semibold text-xl">ACTIVATE YOUR ACCOUNT</p>
          <button className="text-2xl font-semibold bg-[#FFE500] rounded-[10px] px-14 py-4">ACTIVE</button>
        </div>
      </div>
