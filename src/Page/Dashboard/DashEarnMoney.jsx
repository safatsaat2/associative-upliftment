    ...
    return (
        <div>
            ...
            <div className='w-full flex justify-between items-center dashShadow rounded-[10px] mt-6 bg-white'>
                <div>
                <h3 className="text-[32px] font-semibold pt-4 pl-4">Facebook/Youtube/Instagram/Ads/video</h3>
                <p className="text-xl font-semibold pt-6 py-4 pl-4">Invite Your 5 Friends</p>
                </div>
                <button className="text-xl font-semibold pr-4">Get Free</button>
            </div>
        </div>
    );
};

export default DashEarnMoney;