  ...
  return (
    <div className="flex  items-center lg:items-start bg-white">
      <div>
        ...
        <div className={menu === true ? "w-full lg:w-[110px] font-red lg:flex flex-col  rounded-none bg-white h-full" : "w-1/2 lg:w-[160px] font-red lg:flex flex-col  rounded-none sticky top-0 bg-white h-full hidden"}>
