...
const DashNav = () => {
  ...
  return (
    <div className="flex flex-col items-center lg:items-start bg-[#3186EC] max-w-7xl mx-auto">
      ...
      <div className="mx-auto">
        ...
        <div className={menu === true ? "w-full lg:w-[160px] lg:flex flex-col  rounded-none bg-[#3186EC] h-full" : " lg:flex flex-col rounded-none sticky top-0 bg-[#3186EC] h-full hidden"}>
          <div className="flex flex-col lg:flex-row ">
            ...
            <Link to="/dashboard/home" onClick={toTop}>
              <p onClick={() => setMenu(false)} className=" text-black text-[12px] cursor-pointer hover:bg-[#3186EC] hover:text-white rounded-md mx-2 px-3 py-2">
                Home
              </p>
            </Link>
            ...
            <Link to="/dashboard/earnmoney" onClick={toTop}>
              <p onClick={() => setMenu(false)} className="  text-black text-[12px]   cursor-pointer hover:bg-[#3186EC] hover:text-white rounded-md mx-2 px-3 pt-2 ">
                Earn Money
              </p>
            </Link>
