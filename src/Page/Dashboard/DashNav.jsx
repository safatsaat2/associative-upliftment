...
const DashNav = () => {
  ...
  return (
    ...
    <div className={menu === true ? "w-1/2 lg:w-[110px] font-red lg:flex flex-col  rounded-none bg-white h-full" : "w-1/2 lg:w-[110px] font-red lg:flex flex-col  rounded-none sticky top-0 bg-white h-full hidden"}>
