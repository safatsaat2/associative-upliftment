...
const DashComplainBox = () => {
    ...
    return (
        <div>
            ...
            <div className="mb-6 lg:w-[864px] mx-auto mt-5 lg:mt-[48px]">
            ...
            <div className="flex flex-col justify-center items-center lg:w-[864px] mx-auto">
                <div className="w-full">
                    ...
                    <div className="lg:mx-4 ">
                        ...
                        <p className='lg:text-xl font-red font-semibold text-black ml-8 lg:ml-0 lg:mr-4 my-2'>Screenshot</p>
