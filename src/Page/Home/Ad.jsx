  ...
  return (
    <>
      <div className="bg-black py-10">
        <div className="flex max-w-7xl mx-4 lg:mx-auto justify-between items-center gap-x-8">
          <div>
            ...
            <Link to='/services' onClick={toTop}><button className="bg-white px-2 lg:px-0 text-black rounded-lg lg:w-[217px] h-[48px] font-semibold">See Our Services</button></Link>
          </div>
