...
const SignUpNow = () => {
    return (
        <div className="hidden lg:block max-w-7xl bg-black rounded-3xl lg:flex flex-col justify-center items-center mx-auto">
            ...
            <Link to='/signup'><button className='bg-white text-black rounded-lg lg:w-[217px] h-[48px] font-semibold mb-[88px]'>Join Us</button></Link>
        </div>
    );
};
