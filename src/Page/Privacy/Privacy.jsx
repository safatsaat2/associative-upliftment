    ...
    return (
      <>
        <div className="mt-10 max-w-7xl mx-auto">
          ...
          <ul className="mt-4">
            ...
            <li className="mt-4">
              <p>
                ...
                in this Agreement) refers to International Associative Upliftment,
                41 Mojumdari, Sylhet 3100.
              </p>
            </li>
            <li className="mt-4">
              <p>
            ...
            <li className="mt-4">
              <p>
                <strong>Website</strong> refers to Associative Upliftment,
                accessible from{" "}
                <a
                  href="http://www.associativeupliftment.com/"
                  rel="external nofollow noopener"
                >
                  http://www.associativeupliftment.com/
                </a>
              </p>
            </li>
            <li className="mt-4">
          ...
          <ul>
            <li>By email: sulymanxpro@gmail.com</li>
          </ul>
        </div>
