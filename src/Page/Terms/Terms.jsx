  ...
  return (
    <>
      ...
      <p className="mt-6">
        ...
        Companies terms and conditions. The Company, Ourselves, We, Our and Us,
        ...
        purpose of meeting the Clients needs in respect of provision of the
        Companies stated services, in accordance with and subject to, prevailing
        law of bd. Any use of the above terminology or other words in the
      ...
      <p className="mt-6">
        ...
        are reserved. You may access this from International Associative
        Upliftment for your own personal use subjected to restrictions set in
      ...
      <ul>
        ...
        <li className="mt-6">
          Reproduce, duplicate or copy material from International Associative
          Upliftment
        </li>
      ...
      <p className="mt-6">
        ...
        reflect the views and opinions of International Associative
        Upliftment,its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent
        permitted by applicable laws, International Associative Upliftment shall
      ...
      <ul>
        <li className="mt-6">Government agencies;</li>
        <li className="mt-6">Search engines;</li>
        <li className="mt-6">News organizations;</li>
        <li className="mt-6">
      ...
      <ul>
        ...
        <li className="mt-6">online directory distributors;</li>
        <li className="mt-6">internet portals;</li>
        <li className="mt-6">accounting, law and consulting firms; and</li>
      ...
      <p className="mt-6">
        ...
        the hyperlink compensates the absence of International Associative
        Upliftment; and (d) the link is in the context of general resource
        information.
      </p>
